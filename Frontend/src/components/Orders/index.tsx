...
export class Orders extends React.Component <any, any>{
    ...
    FilterFn(){
        var orderIDFilter=this.state.orderIDFilter;
        var orderTypeFilter = this.state.orderTypeFilter;

        var filteredData=this.state.ordersWithoutFilter.filter(
            function(el){
                return el.orderID.toString().toLowerCase().includes(
                    orderIDFilter.toString().trim().toLowerCase()
                )&&
                el.ordertype.toString().toLowerCase().includes(
                    orderTypeFilter.toString().trim().toLowerCase()
                )
            }
        );
...
<div>
    ...
    <tr>
        <th>
            ...
            onClick={()=>this.sortResult('orderID',true)}>
            ...
            <button type="button" className="btn btn-light"
            onClick={()=>this.sortResult('orderID',false)}>
        ...
        <div className="d-flex flex-row">
        <input className="form-control m-2"
            onChange={this.changeorderTypeFilter}
            placeholder="Filter"/>

            <button type="button" className="btn btn-light"
            onClick={()=>this.sortResult('ordertype',true)}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-arrow-down-square-fill" viewBox="0 0 16 16">
                <path d="M2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2zm6.5 4.5v5.793l2.146-2.147a.5.5 0 0 1 .708.708l-3 3a.5.5 0 0 1-.708 0l-3-3a.5.5 0 1 1 .708-.708L7.5 10.293V4.5a.5.5 0 0 1 1 0z"/>
                </svg>
            </button>
            ...
            <button type="button" className="btn btn-light"
            onClick={()=>this.sortResult('ordertype',false)}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-arrow-up-square-fill" viewBox="0 0 16 16">
                <path d="M2 16a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2zm6.5-4.5V5.707l2.146 2.147a.5.5 0 0 0 .708-.708l-3-3a.5.5 0 0 0-.708 0l-3 3a.5.5 0 1 0 .708.708L7.5 5.707V11.5a.5.5 0 0 0 1 0z"/>
                </svg>
            </button>
